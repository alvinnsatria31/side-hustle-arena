...
import { adminJobCatalogue, adminJobs, automationReadinessWithSources, isAdminJob, listAutomationRuns, runAdminJob } from "@/server/admin/jobs";
...
export async function GET(request: Request) {
  try {
    ...
    const readiness = await automationReadinessWithSources();

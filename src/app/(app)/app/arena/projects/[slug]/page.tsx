    ...
    <div>
      <Breadcrumb
        items={[
          ...
          { label: 'Projects', href: '/app/arena/projects' },
          { label: project.title },
        ]}
      />

      <Entrance className="mt-5">
        <div className="relative mb-7 overflow-hidden rounded-[var(--radius-sk-3xl)] bg-sk-navy-2 p-7 text-white sm:p-10">
          <span
            aria-hidden
          ...
          <div className="relative z-[1]">
            ...
            <h1 className="mb-5 mt-3 max-w-[680px] text-[30px] font-extrabold leading-[1.05] tracking-[-0.02em] sm:text-[42px]">
              {project.title}
            </h1>

...
export function AppChrome({ children }: { children: React.ReactNode }) {
  ...
  return <div className="flex min-h-screen flex-col bg-sk-bg"><AppNavbar /><main key={pathname} className="anim-fade-in mx-auto w-full max-w-6xl flex-1 px-4 pb-28 pt-6 sm:px-6 md:pb-16 md:pt-8 lg:px-8">{children}</main><MobileBottomNav /></div>;
}

...
export const reviewStatus = arena.enum("review_status", ["PROCESSING", "COMPLETED_HIDDEN", "PUBLISHED", "FAILED", "VOIDED"]);
...
export const notificationType = notifications.enum("notification_type", ["PROJECT_DROP", "DEADLINE_REMINDER", "SUBMISSION_RECEIVED", "SUBMISSION_ACCESS_FAILED", "RESULT_READY", "POINTS_AWARDED", "REWARD_REDEEMED", "REWARD_FULFILLED"]);
